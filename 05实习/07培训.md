...
- 判定表--因果图
  - ![image-20250729171429280](https://gitee.com/ppedmo/pic-go/raw/master/img/202507291714347.png)
  - ![image-20250729171417796](https://gitee.com/ppedmo/pic-go/raw/master/img/202507291714871.png)
- 错误推测法--基于经验直觉--时间紧的时候
...
- 页面检查字段，翻页
- 输入框，验证：模糊查询、精确查询、空查询
- 关于时间的查询：起始和结束，只有起始，只有结束
- 错误时间是怎么错误的？？--列出所有异常情况
- 组合条件--全组合是必测的，时间紧可以组合几个部分的
- 列表的检查：列表项，数据（显示），翻页检查，结果正确性
...
- 必填项：有和没有都要测试
- 每个必填项为空是怎样，有/没有--其他必填项怎样提示
- 批量新增：
- 导入导出--关注大数据量的情况
- 删：二次确认信息
- 报表：统计数据的准确性
- 熟悉的话：查看研发人员sql语句是否正确
